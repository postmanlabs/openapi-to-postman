/*
  Here we are testing the case where the user has removed 'limit1' request header in the spec.
  The request header should be removed from the request in the collection.
*/
module.exports = {
  name: 'should remove request header',
