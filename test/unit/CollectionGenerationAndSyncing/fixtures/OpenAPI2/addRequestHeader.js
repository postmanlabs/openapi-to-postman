/*
  Here we are testing the case where the user has added 'limit1' request header in the spec.
  The request header should be added to the request in the collection.
*/
module.exports = {
  name: 'should add request header',
