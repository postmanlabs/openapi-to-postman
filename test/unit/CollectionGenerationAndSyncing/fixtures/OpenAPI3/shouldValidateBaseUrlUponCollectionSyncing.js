/*
  Tests the scenario where a baseUrl in the Spec is updated,
  syncing the Spec should update the base url in the associated Collection accordingly.
  Also the other existing variables of the Collection (if any) should not be affected.
*/
module.exports = {
