/*
  Here we are testing the case where the user has renamed 'id', a required request body parameter to 'errId' in the spec.
  The request body parameter should be renamed in the request in the collection.
*/
module.exports = {
  name: 'should rename a request body parameter',
