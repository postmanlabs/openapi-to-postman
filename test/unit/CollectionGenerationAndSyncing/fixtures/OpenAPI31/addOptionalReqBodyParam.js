/*
  Here we are testing the case where the user has added 'id', an optional request body parameter in the spec.
  The request body parameter should be added to the request in the collection.
*/
module.exports = {
  name: 'should add an optional request body parameter',
