/*
  Here we are testing the case where the user has removed 'id', a required request body parameter in the spec.
  The request body parameter should be removed from the request in the collection.
*/
module.exports = {
  name: 'should remove a request body parameter',
