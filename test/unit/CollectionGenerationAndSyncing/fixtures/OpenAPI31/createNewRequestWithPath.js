/*
  ...
  And the request is being added to the collection in the correct location following `Path`
  since the folderStrategy is set to 'Path'
 */
module.exports = {
  name: 'should add new request to collection in correct location - organised using paths',
  specificationType: 'OPENAPI:3.1',
  generationOptions: { folderStrategy: 'Paths' },
  shouldAssertGenerationAndSyncing: true,
  initialState: {
    collection: {
      info: {
        _postman_id: 'f1fbc9f0-3f9b-4269-a359-b72b3d7c95f4',
        name: 'paths',
