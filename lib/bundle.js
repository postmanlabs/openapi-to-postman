...
let path = require('path'),
  ...
  { SWAGGER_VERSION, VERSION_3_1 } = require('./common/versionUtils');
...
function setValueInComponents(keyInComponents, components, value, version) {
  const COMPONENTS_KEYS = version === SWAGGER_VERSION ? COMPONENTS_KEYS_20 :
    version === VERSION_3_1 ? COMPONENTS_KEYS_31 : COMPONENTS_KEYS_30;
