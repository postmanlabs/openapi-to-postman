        ...
        if (hasReferenceTypeKey) {
          ...
          if (local) {
            ...
            if (!contentFromTrace) {
              ...
              if (refData.inline) {
                refData.nodeContent = { [CIRCULAR_Or_REF_EXT_PROP]: property.$ref, [CIRCULAR_REF_EXT_PROP]: true };
              }
              else {
                refData.node = { [CIRCULAR_Or_REF_EXT_PROP]: documentContext.globalReferences[property.$ref].reference,
