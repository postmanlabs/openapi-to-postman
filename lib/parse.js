...
const { getSpecVersion } = require('./common/versionUtils'),
  BROWSER = 'browser',
  OUTER_PROPS_SUPPORTED_VERSIONS = ['3.1'];
...
module.exports = {
  ...
  resolveContent: function (openapi, options, files) {
    return resolver.resolve(openapi, options.source, {
      ...
      outerPropsSupportedVersions: OUTER_PROPS_SUPPORTED_VERSIONS
    });
  },
  ...
  mergeFiles: function(source, options = {}, files = {}) {
    options.targetVersion = getSpecVersion({ type: 'file', data: source });
