...
module.exports = {
  ...
  */
  ...
  parseEndpointParams: function (params, paramLocation) {
    return _.map(_.filter(params, ['in', paramLocation]), (param) => {
      return _.pick(param, ['name', 'description', 'required', 'schema', 'example', 'examples']);
    });
  }
};
