...
module.exports = {
  ...
  analyzeSpec: function (spec) {
    ...
    // No need to check for number of requests or refs if the size is greater than 10 MB
  ...
  determineOptions: function (analysis, options) {
    ...
    // Anything above the size of 10MB will be considered a big spec and given the
