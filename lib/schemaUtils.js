...
module.exports = {
  ...
  */
      ...
      _.forOwn(swagResponse.content, (content, contentType) => {
        if (contentType) {
          ...
          if (contentType === APP_JSON) {
            ...
            // Set the ID of the response for chaining options
            if (operationItem.method.toUpperCase() === 'POST') {
              requestsTests.push(
                '// Chaining - Set ' + operation.operationId + ' ID as environment variable \n' +
   ...
   * @param {*} requestPathVariables request Params Path Variables object
   * @param {*} operation openapi operation object
   * @param {*} operationItem - The operation item to get relevant information for the test generation
   * @param {object} options - a standard list of options that's globally passed around. Check options.js for more.
   * @returns {*} Modified requestBody object
