...
module.exports = {
  ...
  */
  ...
  overwriteRequestPathByTests: function (requestPathVariables, operation, operationItem, options) {
    options = _.merge({}, defaultOptions, options);
    let testRequestPathVariables = Object.assign([], requestPathVariables), // clone requestBody before manipulation
      testSuite = {},
      overwriteValues = [],
      testSuiteOverwriteRequest = {},
      testSuiteOverwriteRequests = [];
  ...
  overwriteRequestQueryParamByTests: function (requestQueryParam, operation, operationItem, options) {
    options = _.merge({}, defaultOptions, options);
    let testRequestQueryParam = Object.assign({}, requestQueryParam), // clone requestBody before manipulation
      testSuite = {},
      overwriteValues = [],
      testSuiteOverwriteRequest = {},
      testSuiteOverwriteRequests = [];
