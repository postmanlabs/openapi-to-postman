...
module.exports = {
  ...
  */
   ...
   */
  async getBundledFileData(parsedRootFiles, inputData, origin, format, version, options = {}) {
    const data = [];
   ...
   */
  async mapProcessRelatedFiles(rootFiles, inputData, origin, version, format, toBundle = false, options = {}) {
    let bundleFormat = format,
      ...
      data = toBundle ?
        await this.getBundledFileData(parsedRootFiles, inputData, origin, bundleFormat, version, options) :
