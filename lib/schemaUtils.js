  ...
  */
              ...
              if (options.suggestAvailableFixes) {
                ...
                _.forEach(filteredValidationError, (ajvError) => {
                  ...
                  if (dataPath === '') {
                    ...
                    let tempSuggestedValue = this.getSuggestedValue(fakedValue, suggestedValue, ajvError);
                    // unset property if suggested value is undefined
                    if (_.isUndefined(tempSuggestedValue)) {
                      _.unset(suggestedValue, dataPath);
                    }
                    else {
                      _.set(suggestedValue, dataPath, tempSuggestedValue);
                    }
                  }
                });
  ...
  getSuggestedValue: function (fakedValue, actualValue, ajvValidationErrorObj) {
    ...
    switch (ajvValidationErrorObj.keyword) {
      ...
      default:
        suggestedValue = this.getPathValue(fakedValue, dataPath, undefined);
        break;
    }
