...
module.exports = {
  ...
  getOptions: function(mode = 'document', criteria = {}) {
    ...
    let optsArray = [
      ...
      {
        name: 'Include changes in name and description',
        id: 'includeDescriptiveChanges',
        type: 'boolean',
        default: false,
        description: 'Whether or not to include changes done in name and description from definition into collection',
        external: false,
        usage: ['VALIDATION'],
        supportedIn: [VERSION30, VERSION31]
      },
      {
        name: 'Include changes in examples',
        id: 'includeExampleChanges',
        type: 'boolean',
        default: false,
        description: 'Whether or not to include changes done in examples from definition into collection',
        external: false,
        usage: ['VALIDATION'],
        supportedIn: [VERSION30, VERSION31]
      },
      {
        name: 'Include changes in optional fields',
        id: 'includeOptionalChanges',
        type: 'boolean',
        default: false,
        description: 'Whether or not to include changes done on optional properties and params' +
          ' from definition into collection',
        external: false,
        usage: ['VALIDATION'],
        supportedIn: [VERSION30, VERSION31]
      }
