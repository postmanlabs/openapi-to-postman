  ...
  convert (callback) {
    ...
    try {
      if (options.folderStrategy === 'tags') {
        schemaUtils.addCollectionItemsUsingTags(openapi, generatedStore, componentsAndPaths, options, schemaCache, sourceMap);
      }
      else {
        schemaUtils.addCollectionItemsUsingPaths(openapi, generatedStore, componentsAndPaths, options, schemaCache, sourceMap);
      }
    }
    catch (e) {
      return callback(e);
