...
class SchemaPack {
  ...
  convert (callback) {
    ...
    */
    ...
    // this needs to be deleted as if an incorrect(non-semver) version is provided to sdk,
    // it returns a version object, with major, minor, patch, etc. properties as undefined.
    // this fails validation against v2.1 collection schema definition.
    if (!collectionJSON.info.version || !collectionJSON.info.version.raw) {
