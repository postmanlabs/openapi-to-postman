...
function safeSchemaFaker(oldSchema, resolveTo, bodyTypeOption, components, schemaFormat, indentCharacter) {
  ...
  try {
    ...
    console.log(schemaFaker(schema), 'here');
  ...
  */
  ...
  convertChildToItemGroup: function(openapi, child) {
    ...
    if (resource.requestCount > 1) {
      ...
      if (resource.childCount === 1 && this.options.collapseLongFolders) {
  ...
  convertToPmBodyData: function(bodyObj, requestType, contentType, bodyTypeOption, indentCharacter = '') {
    ...
    if (bodyObj.example && (this.option.requestParametersResolution === 'example' ||
      this.option.exampleParametersResolution === 'example')) {
    ...
    else if (bodyObj.examples && (this.option.requestParametersResolution === 'example' ||
      this.option.exampleParametersResolution === 'example')) {
