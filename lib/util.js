...
module.exports = {
  ...
  */
  ...
  convertToPmResponseBody: function(contentObj) {
    ...
    if (this.getContentTypeHeaderFormat(cTypeHeader) === HEADER_TYPE.json) {
  ...
  convertToPmBodyData: function(bodyObj, contentType, indentCharacter = '') {
    ...
    if (bodyObj.example) {
      if (bodyObj.example.hasOwnProperty('$ref')) {
        ...
        if (this.getContentTypeHeaderFormat(contentType) === HEADER_TYPE.json) {
      ...
      if (this.options.schemaFaker) {
        if (this.getContentTypeHeaderFormat(contentType) === HEADER_TYPE.xml) {
