...
module.exports = {
  ...
  */
   ...
   *
   * @param {*} openapi object with root-level data like pathVariables baseurl
   * @param {*} tagName name of the folder to be created based on the tag name
   * @param {*} tagObject the tag object containing the description and requests in the folder to be created
   */
  convertTagToItemGroup: function(openapi, tagName, tagObject) {
    var itemGroup,
      description = tagObject.description,
      requests = _.get(tagObject, 'requests', []);
    itemGroup = new sdk.ItemGroup({
      name: tagName,
      description: description
    });
