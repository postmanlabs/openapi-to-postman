  ...
  */
  convertRequestToItem: function(openapi, operationItem) {
    ...
    if (operation.responses) {
      if (!_.find(reqParams.header, {name: ACCEPT_HEADER })) {
        let acceptHeader = new sdk.Header({
          key: ACCEPT_HEADER,
          value: _.join(Object.keys(_.get(operation, 'responses.200.content', {})), ', ')
        });
        acceptHeader.description = 'Advertises which content types, expressed as MIME types, the client is able to understand.';
