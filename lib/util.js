...
* @param {*} stackLimit The depth of nested references to follow while faking a schema
...
*/
function safeSchemaFaker(oldSchema, stackLimit, resolveTo, parameterSourceOption, components,
  schemaFormat, indentCharacter) {
  var prop,
    schema = deref.resolveRefs(oldSchema, stackLimit, parameterSourceOption, components);
...
module.exports = {
      ...
      _.forEach(commonPathVars, (variable) => {
        variables.push({
          ...
          value: this.options.schemaFaker ?
            safeSchemaFaker(variable.schema || {}, this.getSchemaStackLimit(this.openApiSpecSize),
  ...
  convertToPmBodyData: function(bodyObj, requestType, contentType, parameterSourceOption, indentCharacter = '') {
    ...
    if (bodyObj.example && (resolveTo === 'example' || !bodyObj.schema)) {
      ...
      if (this.options.schemaFaker) {
        ...
        bodyData = safeSchemaFaker(bodyObj.schema || {}, this.getSchemaStackLimit(this.openApiSpecSize),
  ...
  convertToPmQueryParameters: function(param, requestType) {
    ...
    if (param.hasOwnProperty('schema')) {
      ...
      paramValue = this.options.schemaFaker ?
        safeSchemaFaker(param.schema, this.getSchemaStackLimit(this.openApiSpecSize),
  ...
  convertToPmHeader: function(header, requestType, parameterSource) {
    ...
    if (header.hasOwnProperty('schema')) {
      if (!this.options.schemaFaker) {
        ...
        fakeData = safeSchemaFaker(header.schema || {}, this.getSchemaStackLimit(this.openApiSpecSize),
  ...
  */
  getSchemaStackLimit: function(openApiSpecSize) {
