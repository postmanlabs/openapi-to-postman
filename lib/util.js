  ...
  convertToPmBody: function(requestBody) {
    ...
    if (contentObj.hasOwnProperty(URLENCODED)) {
      ...
      _.forOwn(bodyData, (value, key) => {
        ...
        if (contentObj[URLENCODED].hasOwnProperty('schema') && contentObj[URLENCODED].schema.type === 'object') {
          description = contentObj[URLENCODED].schema.properties[key].description ?
            contentObj[URLENCODED].schema.properties[key].description : '';
        }
