...
#### v0.2.0 (Nov 21, 2019)
* Handled cases where query have no description property
...
* Added various options for converting OAS into different forms
* Added support for using examples values instead of schema types
